                                ...
                                <div class="p-5">
                                    ...
                                    <form action="{{ route('postreg') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" name="name" placeholder="Nama" value="" required autofocus>
                                        </div>
                                        <input type="hidden" name="_token" value="3kZXorcr2c8pag5Myzn9TkGBZAaSVjbES2qB4QCf">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user mt-3" name="username" placeholder="Username" value="" required autofocus>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            @csrf
                                            <button type="submit" class="btn btn-primary btn-user w-100 mt-3">
                                                Daftar
                                            </button>
                                    ...
                                    <a href="{{ route('reg') }}" class="mt-3 d-block"><i>Sudah memiliki akun?</i></a>
                                    <hr>
                                </div>
                            </div>
                        </div>
